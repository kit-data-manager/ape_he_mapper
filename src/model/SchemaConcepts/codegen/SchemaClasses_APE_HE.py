...
#   timestamp: 2026-01-28T11:10:05+00:00
...
class Affiliation(BaseModel):
    ...
    institutionAddress: Annotated[
        Optional[str],
        Field(description='(Optional) - Full postal address of the institution'),
    ] = None
...
class Energy1(BaseModel):
    min_value: Annotated[
        Optional[float],
        Field(
            description='(required) - Minimum value of Photon energy by default in electronvolts (eV).'
        ),
    ] = -9999
    max_value: Annotated[
        Optional[float],
...
class UserDetails(RootModel[Optional[UserDescription]]):
    root: Optional[UserDescription] = None
