...
#   timestamp: 2026-09-20T15:32:14+00:00
...
class Theta(BaseModel):
    ...
    unit: Annotated[
        Optional[Unit10],
        Field(
            description='(Required) - Unit of measurement for the rotation angle, default: degree.'
        ),
    ] = 'degree'
...
class TransformationsDetails(BaseModel):
    ...
    theta: Annotated[
        Optional[Theta],
        Field(
            description='(Optional)- Rotation angle around the z-axis by default in degree'
        ),
    ] = None
    phi: Annotated[
        Optional[Phi],
        Field(
            description='(Optional)- Rotation angle around the x-axis by default in degree'
        ),
    ] = None
...
class IncidentAngle(BaseModel):
    ...
    unit: Annotated[
        Optional[Unit52],
        Field(description='(Required) - Unit of the incident angle, default: degree.'),
    ] = 'degree'
...
class PrefocusingMirrorDetails(BaseModel):
    ...
    incident_angle: Annotated[
        ...
        Field(description='(Required)- Incident angle by default in degree.'),
    ] = None
